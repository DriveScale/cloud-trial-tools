...
def domain_for_args(args):
    try:
        ...
        print("""\
Unable to locate AWS API credentials.  These consist of the aws_access_key_id
and aws_secret_access_key and are typically placed in ~/.aws/credentials:
...
The --profile option can be used to select a non-default profile from
~/.aws/config.
